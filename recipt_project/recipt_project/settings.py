"""
Django settings for recipt_project project.
...
SECRET_KEY = 'django-insecure-2j%1h14$s3e@t&-ut@m#g*n-_(9$gsd^#6l3ppv+!*ty658t*t'
...
print('Printed Database Connected in settings')
